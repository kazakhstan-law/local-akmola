...
requisite: Решение Атбасарского районного маслихата Акмолинской области от 28 апреля 2023 года № 8С 3/4. Отменен решением Атбасарского районного маслихата Акмолинской области от 23 августа 2023 года № 8С 7/15
form: РЕШ
type_codes:
- РЕШ
approved_by:
...
registry_number: '180936'
source: https://zan.gov.kz/client/#!/doc/180936/rus/28.04.2023
---
...
27. Оценочный лист направляется для рассмотрения оценивающему лицу посредством информационной системы, либо в случае ее отсутствия службой управления персоналом.
    ...
    При выставлении оценок оценивающее лицо использует таблицу определения допустимой оценки в зависимости от процента реализации ключевого целевого индикатора по форме, согласно приложению м к Типовой Методике.
...
31. Оценивающему лицу оценочный лист направляется информационной системой, либо в случае ее отсутствия службой управления персоналом.
    ...
    Оценивающим лицом выставляются оценки (от 0 до 5-ти) в соответствующей графе оценочного листа по форме согласно приложению 4 к Тировой методике.
