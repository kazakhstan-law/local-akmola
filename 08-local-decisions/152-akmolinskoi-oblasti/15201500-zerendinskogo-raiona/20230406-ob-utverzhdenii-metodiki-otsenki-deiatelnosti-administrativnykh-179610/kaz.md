---
version_id: '179610_640132'
act_code: '179610'
language: kaz
title: «Зеренді аудандық мәслихатының аппараты» мемлекеттік мекемесінің «Б» корпусы мемлекеттік әкімшілік қызметшілерінің қызметін бағалаудың әдістемесін бекіту туралы
requisite: Ақмола облысы Зеренді аудандық мәслихатының 2023 жылғы 6 сәуірдегі № 2-7 шешімі. Күші жойылды - Ақмола облысы Зеренді аудандық мәслихатының 2025 жылғы 24 қарашадағы № 36-279 (алғашқы ресми жарияланған күнінен кейін күнтізбелік он күн өткен соң қолданысқа енгізіледі) шешімімен
form: РЕШ
type_codes:
- РЕШ
approved_by:
...
registry_number: '179610'
caused_by:
  code: '183662'
  title: Зеренді аудандық мәслихатының 2023 жылғы 6 сәуірдегі № 2-7 «Зеренді аудандық мәслихатының аппараты» мемлекеттік мекемесінің «Б» корпусы мемлекеттік әкімшілік қызметшілерінің қызметін бағалаудың әдістемесін бекіту туралы» шешіміне өзгеріс енгізу туралы
  link: https://zan.gov.kz/client/#!/doc/183662/kaz
source: https://zan.gov.kz/client/#!/doc/179610/kaz/03.07.2023
---

# «Зеренді аудандық мәслихатының аппараты» мемлекеттік мекемесінің «Б» корпусы мемлекеттік әкімшілік қызметшілерінің қызметін бағалаудың әдістемесін бекіту туралы

> *Ескерту. 3-тармағының 12) тармақшасы, 6-тармағының екінші абзацы және 6-тарауы 31.08.2023 дейін қолданылады - Ақмола облысы Зеренді аудандық мәслихатының 03.07.2023 № 8-48 (оның алғаш ресми жарияланған күннен кейін күнтізбелік он күн өткен соң қолданысқа енгізіледі) шешімнің 2-тармағымен.*

«Қазақстан Республикасының мемлекеттік қызметі туралы» Қазақстан Республикасының Заңының 33-бабының 5-тармағына, «Мемлекеттік әкімшілік қызметшілердің қызметін бағалаудың кейбір мәселелері туралы» Қазақстан Республикасы Мемлекеттік қызмет істері агенттігі Төрағасының 2018 жылғы 16 қаңтардағы № 13 бұйрығымен (Нормативтік құқықтық актілерді мемлекеттік тіркеу тізілімінде № 16299 болып тіркелген) бекітілген «Б» корпусы мемлекеттік әкімшілік қызметшілерінің қызметін бағалаудың үлгілік әдістемесіне сәйкес, Зеренді аудандық мәслихаты ШЕШТІ:

1. Қоса берілген «Зеренді аудандық мәслихатының аппараты» мемлекеттік мекемесінің «Б» корпусы мемлекеттік әкімшілік қызметшілерінің қызметін бағалаудың әдістемесі бекітілсін.

2. Зеренді аудандық мәслихатының келесі шешімдерінің күші жойылсын:

   Зеренді аудандық мәслихатының 2021 жылғы 18 маусымдағы № 7-47 «Зеренді аудандық мәслихатының аппараты» мемлекеттік мекемесінің «Б» корпусы мемлекеттік әкімшілік қызметшілерінің қызметін бағалаудың әдістемесін бекіту туралы» шешімі;

   Зеренді аудандық мәслихатының 2022 жылғы 25 ақпандағы № 16-109 «Зеренді аудандық мәслихатының 2021 жылғы 18 маусымдағы № 7-47 «Зеренді аудандық мәслихатының аппараты» мемлекеттік мекемесінің «Б» корпусы мемлекеттік әкімшілік қызметшілерінің қызметін бағалаудың әдістемесін бекіту туралы» шешіміне өзгерістер енгізу туралы» шешімі.
