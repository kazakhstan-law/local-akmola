...
requisite: Ақмола облысы Астрахан аудандық мәслихатының 2016 жылғы 24 маусымдағы № 6С-5-6 шешімі. Ақмола облысының Әділет департаментінде 2016 жылғы 25 шілдеде № 5478 болып тіркелді. Күші жойылды - Ақмола облысы Астрахан аудандық мәслихатының 2017 жылғы 10 ақпандағы № 6С-15-2 шешімімен
form: РЕШ
type_codes:
- МЕТ
- РЕШ
...
registry_number: '105409'
source: https://zan.gov.kz/client/#!/doc/105409/kaz/24.06.2016
---
...
> *2016 жылғы 24 маусымдағы № 6С-5-6*  
...
1. Осы «Астрахан аудандық мәслихатының аппараты» мемлекеттік мекемесінің (бұдан әрі – аудандық мәслихаттың аппараты) «Б» корпусы мемлекеттік әкімшілік қызметшілерінің қызметін бағалаудың әдістемесі (бұдан әрі – Әдістеме) «Қазақстан Республикасының мемлекеттік қызметі туралы» 2015 жылғы 23 қарашадағы Қазақстан Республикасының Заңының 33 бабының 5 тармағына, Қазақстан Республикасының Мемлекеттік қызмет істері министрінің 2015 жылғы 29 желтоқсандағы № 13 бұйрығымен бекітілген «Б» корпусы мемлекеттік әкімшілік қызметшілерінің қызметін бағалаудың үлгілік әдістемесіне (Нормативтік құқықтық актілерді мемлекеттік тіркеу тізілімінде № 12705 тіркелген) (бұдан әрі – Үлгілік әдістеме) сәйкес әзірленді және «Б» корпусы мемлекеттік әкімшілік қызметшілерінің (бұдан әрі – «Б» корпусының қызметшілері) қызметін бағалау алгоритмін айқындайды.
...
37. Комиссия хатшысы «Б» корпусы қызметшісінің жылдық қорытынды бағасын мына формула бойынша Бағалау жөніндегі комиссия отырысына дейін бес жұмыс күнінен кешіктірмей есептейді:
    ...
    Ʃ жыл = 0,3* Ʃт+0,6* Ʃ ИП+0,1* Ʃ к

    Ʃжыл– жылдық баға;

    Ʃт – есептік тоқсандардың орта бағасы (орта арифметикалық мән).
    ...
    «өтежақсы» мәнге (130 баллданастам) – 5 балл;

    Ʃ ИП – жеке жұмыс жоспарын орындау бағасы (орта арифметикалық мән);

    Ʃк – айналмалы бағалау (орта арифметикалықмән).
